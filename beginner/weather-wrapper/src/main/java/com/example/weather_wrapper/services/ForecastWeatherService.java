...
@Service("external")
public class ForecastWeatherService implements WeatherService{
    ...
    private static final Logger LOGGER = LoggerFactory.getLogger(ForecastWeatherService.class);
    ...
    public ForecastWeatherService(RestClient.Builder builder) {
    ...
    public CityForecast getForecastForCity(String city){
        ...
        var response = this.restClient.get()
                ...
                .onStatus(HttpStatusCode::is4xxClientError, (req, res) -> {
                    LOGGER.error("Get 4xx error for city {}", city);
